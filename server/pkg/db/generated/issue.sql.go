...
) RETURNING id, workspace_id, title, description, status, priority, assignee_type, assignee_id, creator_type, creator_id, parent_issue_id, acceptance_criteria, context_refs, position, due_date, created_at, updated_at, number, project_id, github_repo, github_issue_number, github_pr_number
`
...
SELECT id, workspace_id, title, description, status, priority, assignee_type, assignee_id, creator_type, creator_id, parent_issue_id, acceptance_criteria, context_refs, position, due_date, created_at, updated_at, number, project_id, github_repo, github_issue_number, github_pr_number FROM issue
WHERE id = $1
`
...
UPDATE issue SET
    ...
    parent_issue_id = $10,
    project_id = $11,
    github_repo = COALESCE($12, github_repo),
    github_issue_number = COALESCE($13, github_issue_number),
    github_pr_number = COALESCE($14, github_pr_number),
    updated_at = now()
WHERE id = $1
RETURNING id, workspace_id, title, description, status, priority, assignee_type, assignee_id, creator_type, creator_id, parent_issue_id, acceptance_criteria, context_refs, position, due_date, created_at, updated_at, number, project_id, github_repo, github_issue_number, github_pr_number
`
